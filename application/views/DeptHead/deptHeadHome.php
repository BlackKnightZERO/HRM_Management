	    		...
	    		<div class="row">
	    			...
	    			<div class="col-lg-3 col-md-3 col-sm-12 col-12" style="margin-bottom: 10px;">
	    				<div class="list-group">
	    				  <?php echo anchor('DeptHeadController/deptHeadHome','<span><i class="fas fa-home"></i></span>
	    				    Home', ['class'=>'list-group-item list-group-item-action active main-color-bg']); ?>

	    				    <?php echo anchor('DeptHeadController/deptHeadUpdateInfo','<span><i class="fas fa-pen-nib"></i></span>
	    				    Update Info', ['class'=>'list-group-item list-group-item-action']); ?>

	    				  <?php echo anchor('DeptHeadController/deptHeadApplyLeave', 
	    				  '<span><i class="fas fa-coffee"></i></span> Apply for Leave  <span class="badge badge-secondary float-right m-1">12</span>', 
	    				  ['class'=>'list-group-item list-group-item-action']); ?>


	    				  <?php echo anchor('DeptHeadController/deptHeadViewEmployeeList', 
	    				    ...
	    				    <div class="card-body">
	    				    	...
	    				    	//	echo "<br>"; 
	    				    		...
	    				    		else
	    				    		{
			    				    		...
			    				    		{
			    				    			if( $result == $this->session->userdata('sessionid') && $result != NULL && $kkey>0 )
			    				    			{
			    				    				$checkvar = 1;
			    				    				break;
			    				    			}
