...
?>
<?php 
if($this->session->userdata('headsessionid') == NULL) {

	return redirect('loginController/userLogin');
}
?>
<!-- <?php echo $this->session->userdata('headsessionid'); ?> -->
<!DOCTYPE html>
<html>
<head>
	...
	<nav class="navbar navbar-expand-sm">
	     &nbsp; <h4 style="color: #ffffff"><span><i class="far fa-user"></i></span></h4> &nbsp; &nbsp; <?php echo anchor('AdminController/adminDashboard',' Employee Profile', ['class'=>'navbar-brand']); ?>
	      ...
	      <ul class="navbar-nav navbar-right">
	          <li class="nav-item">
	            <a class="nav-link" href="#">Welcome, <?php echo $this->session->userdata('headsessionname');?></a>
	          </li>
	          <li class="nav-item">
